__Forked for the purpose of creating a different package structure, so it can be used along side a dependency to graphdb-free-runtime, which is closed source and has a copy of outdated jsi sources packaged within, creating a conflict.__
